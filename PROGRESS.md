...
| STATE01 | Manifest v2 and state migration | REG01 | in_progress | `codex/aart-1-0-state01-state-migration` | pending | Backup/dry-run/rollback |
...
| STATE01 | 28 pass + 8 subtests | 309 files pass | pass | 135 source files pass | 1225 pass | 28 pass | 11-step pass | pass | 86.59% overall (≥82%) | `1.0.0a1` wheel/import pass | pass | local Python 3.14 all 1225 pass; CI pending |
