...
commands below were exercised against the published `v2.6.1` artifact or tag.

| Source | `pip` (inside your environment) | `pipx` | `uv` |
|---|---|---|---|
| Downloaded wheel | `python -m pip install --no-deps ./agent_artifacts-2.6.1-py3-none-any.whl` | `pipx install ./agent_artifacts-2.6.1-py3-none-any.whl` | `uv tool install ./agent_artifacts-2.6.1-py3-none-any.whl` |
| GitHub release wheel | `python -m pip install --no-deps https://github.com/M1F1/agent-artifacts/releases/download/v2.6.1/agent_artifacts-2.6.1-py3-none-any.whl` | `pipx install https://github.com/M1F1/agent-artifacts/releases/download/v2.6.1/agent_artifacts-2.6.1-py3-none-any.whl` | `uv tool install https://github.com/M1F1/agent-artifacts/releases/download/v2.6.1/agent_artifacts-2.6.1-py3-none-any.whl` |
| Tagged Git repository, no clone | `python -m pip install --no-deps "git+https://github.com/M1F1/agent-artifacts.git@v2.6.1"` | `pipx install "git+https://github.com/M1F1/agent-artifacts.git@v2.6.1"` | `uv tool install "git+https://github.com/M1F1/agent-artifacts.git@v2.6.1"` |
